...
macro_dir="/Users/hoatran/Documents/python_workspace/TissueJ4Proteins/macros/nuc_segmentation/"
project_dir="/Users/hoatran/Documents/others/jean_project/data/large_tissue_seg/"

series="small_tissue_tiles" 
...
${imagej_dir}jre/bin/java -Xmx20000m -jar $imagej_exe_file -ijpath $imagej_dir -batch $macro_fn $input_dir
