...
macro_dir="/Users/hoatran/Documents/python_workspace/TissueJ4Proteins/macros/MultiPDXs_Ms1134_macro/"
project_dir="/Users/hoatran/Documents/others/jean_project/data/MultiPDXs_Ms1134/"

series="NUC_raw_tiles" 
task="cell_zone_detection" # Nuc segmentation
...
# imagej_exe_file=${imagej_dir}jars/ij-1.53q.jar  ## Fiji file location, in general file name is ij.jar, sometimes include version here, ex: ij-1.53q.jar, version 1.53
...
macro_fn="${macro_dir}cell_zone_detection.txt"



log_file="${macro_dir}${series}_${task}.log"
echo $log_file
exec >> $log_file 2>&1 && tail $log_file

input_dir="${project_dir}/results/SEG_temporary_files/"
...
${imagej_dir}jre/bin/java -Xmx30000m -jar $imagej_exe_file -ijpath $imagej_dir -batch $macro_fn $input_dir
