...
public class DetectCellType_protein implements ij.plugin.PlugIn {
...
//        dir = IJ.getDirectory("image");
    ...
    public void analysis_v2(ImageInt imgSeg, ImageInt imgWat,
                         ArrayList<ImageInt> lsbin, ArrayList<ImageInt> lsraw, 
                         String save_dir){
...
//        HashMap<Integer, Cell> region2Cell=null;
    ...
    //                IJ.saveAs("Tiff", save_dir + image_fn+"_WAT" + ".tif");
                    IJ.saveAs(imgWat.getImagePlus(), "ZIP", save_dir + image_fn+"_WAT" + ".zip");
                } else{
...
////        TO DO: wat, cell networks
        ...
        IJ.log("Nb images bin is: " + lsbin.size());
        IJ.log("Nb images raw is: " + lsraw.size());
        computeCellTypeV2(lsbin, lsraw, save_dir, image_fn); 
        IJ.log("Completed");
        IJ.log("====================================================================\n");
    }
